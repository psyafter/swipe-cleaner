            ...
            MaterialTheme {
                Surface(modifier = Modifier.fillMaxSize()) {
                    SwipeCleanerScreen(
                        ...
                        onSkipOnboarding = viewModel::completeOnboarding,
                        ...
                        onSetSmartModeEnabled = viewModel::setSmartModeEnabled,
                        onDismissDeleteConfirmation = viewModel::dismissDeleteConfirmationDialog,
                        onConfirmDeleteNow = viewModel::confirmDeletion,
                        onShowSmartModeInfo = viewModel::toggleSmartModeInfoDialog,
                        onShowLanguageDialog = viewModel::toggleLanguageDialog,
                        onSetLanguage = viewModel::setAppLanguage,
                        onOpenReviewSelected = viewModel::openReviewSelected,
                        onCloseReviewSelected = viewModel::closeReviewSelected,
                        onUnmarkItem = viewModel::unmarkFromSelection,
